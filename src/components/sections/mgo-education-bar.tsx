...
const MGOEducationBar = () => {
  ...
  return (
    <div className="py-12 border-y border-amber-900/10 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col gap-8">
          ...
          <div className="relative h-2 bg-amber-900/10 rounded-full flex items-center">
            {mgoLevels.map((item, index) => (
              ...
              >
                <div className={`w-4 h-4 rounded-full border-2 border-white ${item.color} shadow-[0_0_15px_rgba(212,147,10,0.3)]`} />
