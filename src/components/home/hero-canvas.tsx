...
export const HeroCanvas = () => {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-screen overflow-hidden bg-void">
      <canvas ref={canvasRef} className="block w-full h-full object-cover" style={{ willChange: 'transform' }} />
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="act-2-block absolute inset-0 flex items-center justify-start px-12 md:px-24 opacity-0">
          <div className="max-w-xl">
            ...
            <h2 className="act-2-heading text-5xl md:text-8xl font-display font-semibold text-text-primary leading-display">Bio-Active <br /><span className="act-2-clip text-amber-500 inline-block">Potency.</span></h2>
          </div>
        </div>
        <div className="act-3-block absolute inset-0 flex items-center justify-end px-12 md:px-24 opacity-0">
          <div className="text-right max-w-xl">
            ...
            <h2 className="text-5xl md:text-8xl font-display font-semibold text-text-primary leading-display mb-8">
              <span className="act-3-line-1 block">The Science</span>
              <span className="act-3-line-2 block text-amber-500">of MGO.</span>
            </h2>
            <ul className="act-3-bullets space-y-4 text-text-secondary font-medium tracking-wide">
        ...
        <div className="act-4-block absolute inset-0 flex flex-col items-center justify-center opacity-0">
          <div className="act-4-content text-center px-6">
            <h2 className="text-5xl md:text-8xl font-display font-bold text-text-primary mb-12">Secure Your <br /><span className="text-amber-500">Liquid Gold.</span></h2>
      ...
      {!isLoaded && (
        <div className="absolute inset-0 bg-void flex items-center justify-center z-50">
          <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-xs text-amber-500 font-bold uppercase tracking-widest">Charging Potency...</span>
          </div>
        </div>
      )}
    </div>
