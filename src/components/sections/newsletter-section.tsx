    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 glass-panel p-12 md:p-24 rounded-[4rem] border-amber-500/10 flex flex-col items-center text-center gap-10">
         ...
         <div className="flex flex-col gap-4">
            <div className="flex items-center justify-center gap-2 text-amber-500 text-xs font-bold uppercase tracking-[0.4em]">
              <Sparkles className="w-4 h-4" />
              <span>Join the Community</span>
              <Sparkles className="w-4 h-4" />
            </div>
            <h2 className="text-4xl md:text-6xl font-display font-bold text-text-primary">
               Get <span className="text-amber-500">10% Off</span> Your <br />First Order
            </h2>
