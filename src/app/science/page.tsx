      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-6 mb-20 max-w-3xl">
           ...
           <h1 className="text-5xl md:text-7xl font-display font-bold text-text-primary leading-[1.1]">
             The Science of <br /><span className="text-amber-500">MGO Potency</span>
           </h1>
           <p className="text-xl text-text-secondary leading-relaxed mt-4">
             Understanding the unique antibacterial properties that make Australian Manuka honey a world-renowned wellness superfood.
           </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-32">
           <div className="glass-panel p-10 rounded-[3rem] border-amber-500/10">
              ...
              <div className="space-y-6 text-text-secondary leading-relaxed">
                <p>
                  Methylglyoxal (MGO) is the naturally occurring compound that gives Manuka honey its exceptional antibacterial activity. While all honey has some level of antibacterial properties, Manuka is unique because its MGO levels are stable and resistant to heat and light.
                </p>
                <p>
                  The higher the MGO number, the stronger the antibacterial activity and the more potent the honey is for therapeutic use.
                </p>
              </div>
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                { icon: Microscope, title: "Wound Care", text: "Clinical-grade healing properties." },
        ...
        <div className="mt-32 flex flex-col md:flex-row items-center justify-between gap-12 bg-earth/30 p-12 rounded-[3rem] border border-amber-900/10">
           <div className="flex flex-col gap-2">
              ...
              <p className="text-text-secondary">Download our latest laboratory batch reports.</p>
           </div>
